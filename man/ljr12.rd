\name{ljr12}
\alias{ljr12}
\title{Perform test of 1 vs 2 joinpoints.}
\description{
 This function tests the null hypothesis of one joinpoint versus the alternative of two joinpoints based on the likelihood ratio test statistic.  The p-value is determined by a Monte Carlo method.
}
\usage{
ljr12(y,n,tm,X,ofst,R=1000,alpha=.05)
}
\arguments{
...
\seealso{
 \code{\link{ljr1},\link{ljr2},\link{ljrb2},\link{ljrf2}}
}
...
\examples{
 ...
 temp.ljr=ljr12(y,n,tm,X,ofst,R=1000)
}
\keyword{nonlinear}
