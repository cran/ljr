\name{ljrb2}
\alias{ljrb2}
\title{Perform backward joinpoint selection algorithm with K=2.}
\description{
 This function performs the backward joinpoint selection algorithm with K=2 maximum possible number of joinpoints based on the likelihood ratio test statistic.  The p-value is determined by a Monte Carlo method.
}
\usage{
ljrb2(y,n,tm,X,ofst,R=1000,alpha=.05)
}
\arguments{
...
\seealso{
	\code{\link{ljr0},\link{ljr1},\link{ljr2},\link{ljrb}}
}
\examples{
 N=20
 m=2
 ...
 temp.ljr=ljrb2(y,n,tm,X,ofst,R=1000)
}
\keyword{nonlinear}
